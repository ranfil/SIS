        ...
        with open('data.csv','r') as csv_file:
                ...
                for line in read:
                        ...
                        if(line['id#'].startswith(searchword) or (line['name'].lower()).startswith(searchword.lower())):
                                ...
                                currFrame = Frame(myFrame, bg="White", highlightbackground="#9FE2BF", highlightthickness=3, height=100, width=470)
...
def info_window(command,student):
        ...
        thisFrame = LabelFrame(infoWindow,bg="#808000")
...
header = Frame(root, height=100, width=500, bg="#808000")
header.propagate(0)
